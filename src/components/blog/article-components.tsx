...
export const articleComponents = {
  ...
  ol: (props: ComponentPropsWithoutRef<"ol">) => <ol {...props} className={`${styles.list} ${styles.orderedList}`} />,
  ...
  ul: (props: ComponentPropsWithoutRef<"ul">) => <ul {...props} className={`${styles.list} ${styles.unorderedList}`} />,
  Callout,
  Citation,
  DataTable,
};
