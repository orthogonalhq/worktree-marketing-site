...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Worktree vs. Grok Bot, Hermes Agent & OpenClaw",
    description:
      "Compare four AI agent operating models and decide which responsibilities your team wants to own.",
    type: "article",
  },
};
...
export default function CompareAiAgentApproachesPage() {
  ...
  return (
    <WorktreeShell>
      ...
      <section className={`${styles.hero} section-pad px-4 pt-16 sm:px-6 lg:px-10`} aria-labelledby="compare-heading">
      ...
      <section className={`${styles.section} section-pad px-4 sm:px-6 lg:px-10`} aria-labelledby="short-answer-heading">
        <div className="mx-auto max-w-7xl">
      ...
      <section id="comparison" className={`${styles.section} section-pad px-4 sm:px-6 lg:px-10`} aria-labelledby="comparison-heading">
        <div className="mx-auto max-w-7xl">
          <div className={styles.sectionIntro}>
      ...
      <section className={`${styles.section} section-pad px-4 sm:px-6 lg:px-10`} aria-labelledby="approaches-heading">
        <div className="mx-auto max-w-7xl">
          <div className={styles.sectionIntro}>
      ...
      <section className={`${styles.section} section-pad px-4 sm:px-6 lg:px-10`} aria-labelledby="operating-gap-heading">
        <div className="mx-auto max-w-7xl">
      ...
      <section className={`${styles.section} section-pad px-4 sm:px-6 lg:px-10`} aria-labelledby="cost-heading">
        <div className="mx-auto max-w-7xl">
          <div className={styles.sectionIntro}>
      ...
      <section className={`${styles.section} section-pad px-4 sm:px-6 lg:px-10`} aria-labelledby="build-or-buy-heading">
        <div className="mx-auto max-w-7xl">
          <div className={styles.sectionIntro}>
      ...
      <section className={`${styles.section} section-pad px-4 sm:px-6 lg:px-10`} aria-labelledby="worktree-process-heading">
        <div className="mx-auto max-w-7xl">
          <div className={styles.sectionIntro}>
      ...
      <section className={`${styles.section} section-pad px-4 sm:px-6 lg:px-10`} aria-labelledby="faq-heading">
      ...
      <section className={`${styles.finalCta} section-pad px-4 sm:px-6 lg:px-10`} aria-labelledby="final-cta-heading">
        <div className="mx-auto max-w-5xl">
