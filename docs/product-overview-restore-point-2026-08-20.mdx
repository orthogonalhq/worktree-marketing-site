# Product overview restore point

Captured before the product-hub rebuild on 2026-08-20.

Restore target: `src/app/product/page.tsx`
...
export const metadata: Metadata = createPageMetadata({
  title: "Managed Agent Deployment",
